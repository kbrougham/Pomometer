...
class MilestonesControllerTest < ActionController::TestCase
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post :create, milestone: { ends_at: @milestone.ends_at, name: @milestone.name, starts_at: @milestone.starts_at }
    end
  ...
  test "should update milestone" do
    put :update, id: @milestone, milestone: { ends_at: @milestone.ends_at, name: @milestone.name, starts_at: @milestone.starts_at }
    assert_redirected_to milestone_path(assigns(:milestone))
  end
